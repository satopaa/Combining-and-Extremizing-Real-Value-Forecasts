...
In this paper weighted averaging is analyzed under the general partial information framework. This means that the outcome and the forecasts share a probability space but are not restricted to any particular dependence structure. Our first contribution extends the result
