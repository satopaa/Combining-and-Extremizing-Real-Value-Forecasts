...
In probability forecasting the under-confidence of a simple aggregator, such as the average or median forecast, is typically alleviated by \textit{extremizing}, that is, by systematically transforming the aggregate towards its nearer extreme (at zero or one). 
...
\marginpar{why linear transformation}
