...
To show these kinds of inefficiency results directly with Definition \ref{infoAgg} can be challenging. An easier approach is to first understand the common properties of all efficient aggregators. This then gives a ``toolbox'' for checking whether a given aggregator, such as the weighted average or median, behaves like an efficient aggregator.  
