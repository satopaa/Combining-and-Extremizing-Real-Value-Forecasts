...
forecasts into a single consensus forecast. This consensus can be then considered to represent all the experts' advice. 
% is done both for
%the sake of decision-making and
%accuracy \citep{armstrong2}. 
The decision-makers, however, can choose to aggregate the forecasts in many different ways. The final choice of the combination rule is crucial because it can
...
In particular, by today it has become  a well-established practice in many organizations, including central banks, government institutions, and other businesses. 
