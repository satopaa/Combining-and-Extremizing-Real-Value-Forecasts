...
median and extends, in a different form, to real-valued estimated.

\textit{Extremizing}e, transforming the weighted average forecast away from the marginal mean,
has been widely used in the probability forecasting literature as a means of
...
The general result of this paper, however, suggests that extremizing can improve both
