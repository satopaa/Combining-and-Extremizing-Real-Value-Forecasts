...
Under-confidence of a simple aggregators can be often alleviated by systematically transforming it away from the naive baseline forecast, namely the marginal mean of the outcome. 
...
Our second contribution illustrates this with a quadratic programming technique that linearly extremizes the weighted average. The technique is applied to simple examples involving both synthetic and real-world data. In both examples extremizing leads to a significant improvement in the resolution and reliability of the weighted average. In particular, the resulting aggregate exhibits properties of optimal aggregation.
